...
import { sponsorSchema } from '../schemas/sponsor-table-schema'
import { SponsorInfosForApprovalDialog } from './sponsor-infos-for-apporval-dialog'
...
export function DataTableRowActions<TData>({
  ...
  const link = sponsorSchema.parse(row.original)
