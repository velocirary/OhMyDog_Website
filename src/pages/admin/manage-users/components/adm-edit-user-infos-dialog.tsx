...
import {
  ...
  manageUserSchema,
} from '../schemas/manage-users-form-schema'
...
export function AdmEditUserInfosDialog({
  userID,
  closeDialog,
}: UserEditInfosDialogProps) {
        ...
        <section className="my-8">
          ...
          <article className="mx-1 mt-8  space-y-2">
            ...
            <Controller
              name="status"
              control={control}
              defaultValue={userInfos?.status ? userInfos?.status : ''}
                ...
                <Select onValueChange={field.onChange} value={field.value}>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="N">Desativado</SelectItem>
                    </SelectGroup>
                  </SelectContent>
                </Select>
              )}
